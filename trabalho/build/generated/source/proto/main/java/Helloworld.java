...
public final class Helloworld {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return Helloworld.internal_static_HelloResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Helloworld.HelloResponse.class, Helloworld.HelloResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Helloworld.HelloResponse)) {
        return super.equals(obj);
      }
      Helloworld.HelloResponse other = (Helloworld.HelloResponse) obj;
    ...
    public static Helloworld.HelloResponse parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Helloworld.HelloResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Helloworld.HelloResponse parseFrom(
    ...
    public static Helloworld.HelloResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Helloworld.HelloResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Helloworld.HelloResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Helloworld.HelloResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        Helloworld.HelloResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Helloworld.internal_static_HelloResponse_descriptor;
      }
      ...
      // Construct using Helloworld.HelloResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public Helloworld.HelloResponse getDefaultInstanceForType() {
        return Helloworld.HelloResponse.getDefaultInstance();
      }

      @java.lang.Override
      public Helloworld.HelloResponse build() {
        Helloworld.HelloResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public Helloworld.HelloResponse buildPartial() {
        Helloworld.HelloResponse result = new Helloworld.HelloResponse(this);
        result.text_ = text_;
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Helloworld.HelloResponse) {
          return mergeFrom((Helloworld.HelloResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Helloworld.HelloResponse other) {
        if (other == Helloworld.HelloResponse.getDefaultInstance()) return this;
        if (!other.getText().isEmpty()) {
          text_ = other.text_;
          onChanged();
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Helloworld.HelloResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Helloworld.HelloResponse) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final Helloworld.HelloResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Helloworld.HelloResponse();
    }

    public static Helloworld.HelloResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "uest\032\016.HelloResponse\"\000b\006proto3"
    };
