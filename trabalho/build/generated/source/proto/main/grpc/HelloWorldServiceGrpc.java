...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Helloworld.HelloRequest,
      Helloworld.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = Helloworld.HelloRequest.class,
      responseType = Helloworld.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Helloworld.HelloRequest,
      Helloworld.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<Helloworld.HelloRequest, Helloworld.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<Helloworld.HelloRequest, Helloworld.HelloResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Helloworld.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    public void hello(Helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<Helloworld.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public Helloworld.HelloResponse hello(Helloworld.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Helloworld.HelloResponse> hello(
